      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Connect your Spotify account to view your last 100 listened tracks
          </p>
          {authUrlQuery.data && (
            <a
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-4">Failed to load your listening history</p>
          <button
            onClick={() => {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-4">
          {tracks.map((item: SpotifyRecentTrack, index: number) => (
            <TrackCard key={`${item.track.id}-${item.played_at}-${index}`} track={item} />
          ))}
        </div>
      </div>
    </div>
